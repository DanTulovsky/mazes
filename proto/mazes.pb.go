...
type RegisterClientRequest struct {
	...
	PathColor string `protobuf:"bytes,2,opt,name=pathColor" json:"pathColor,omitempty"`
}
...
func (m *RegisterClientRequest) GetPathColor() string {
	if m != nil {
		return m.PathColor
	}
	return ""
...
func (*Cell) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func (*MazeLocation) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
var fileDescriptor0 = []byte{
	...
	,
}
