...
func (m *ResetClientRequest) String() string            { return proto1.CompactTextString(m) }
func (*ResetClientRequest) ProtoMessage()               {}
func (*ResetClientRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
type ResetClientReply struct {
	...
	CurrentLocation *MazeLocation `protobuf:"bytes,3,opt,name=current_location,json=currentLocation" json:"current_location,omitempty"`
}

func (m *ResetClientReply) Reset()                    { *m = ResetClientReply{} }
func (m *ResetClientReply) String() string            { return proto1.CompactTextString(m) }
func (*ResetClientReply) ProtoMessage()               {}
func (*ResetClientReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*ExportMazeRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*ExportMazeReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*RegisterClientRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (*RegisterClientReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (*SolveMazeRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*SolveMazeResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func (*Direction) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
func (*Maze) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
func (*Cell) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }
...
func (*ListMazeRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func (*ListMazeReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
func (*CreateMazeRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{13} }
...
func (*CreateMazeReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{14} }
...
func (*MazeConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{15} }
...
func (*ClientConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{16} }
...
func (*MazeLocation) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{17} }
...
func init() {
	proto1.RegisterType((*ResetClientRequest)(nil), "proto.ResetClientRequest")
	proto1.RegisterType((*ResetClientReply)(nil), "proto.ResetClientReply")
...
func (c *mazerClient) ResetClient(ctx context.Context, in *ResetClientRequest, opts ...grpc.CallOption) (*ResetClientReply, error) {
	...
	err := grpc.Invoke(ctx, "/proto.Mazer/ResetClient", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
