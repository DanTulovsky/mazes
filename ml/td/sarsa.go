...
func printProgress(e, numEpisodes int64, epsilon float64) {
...
func runEpisode(m *maze.Maze, clientID string, svf *ml.StateActionValueFunction,
...
func Sarsa(m *maze.Maze, clientID string, numEpisodes int64, alpha float64, df float64,
	...
	for e := int64(0); e < numEpisodes; e++ {
		...
		printProgress(e, numEpisodes, epsilon)

		if err := runEpisode(m, clientID, svf, p, fromCell, toCell, maxSteps, df, alpha, epsilon); err != nil {
			return nil, nil, err
		}
